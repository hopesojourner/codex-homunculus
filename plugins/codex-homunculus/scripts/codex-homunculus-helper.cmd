...
if not exist "%PLUGIN_ROOT%\scripts\homunculus-helper.mjs" (
  set "PLUGIN_ROOT=%~dp0.."
)

if not exist "%PLUGIN_ROOT%\scripts\homunculus-helper.mjs" (
  echo error: could not find Codex Homunculus helper root. Set CODEX_HOMUNCULUS_PLUGIN_ROOT. 1>&2
  exit /b 1
)
...
node "%PLUGIN_ROOT%\scripts\homunculus-helper.mjs" %*
